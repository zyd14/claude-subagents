...
tools: Read, Write, Edit, Bash, Glob, Grep, mcp__memory2__read_graph, mcp__memory2__search_nodes, mcp__memory2__open_nodes
---
...
- Integration tests
- Documentation
- Ensure tests are meaningful and don't test language or 3rd party dependency features
